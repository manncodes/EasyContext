...
def prepare_inputs_data_parallel(input_ids, position_ids, target_ids, process_index, num_processes, device):
    """Simple data parallel preparation - no sequence parallel"""
    return {
...
def main(args):
    ...
    for step, batch in enumerate(train_loader):
        ...
        # Simple data parallel preparation
        prepared = prepare_inputs_data_parallel(
            input_ids,
            position_ids,
            target_ids,
